...
[![Test Coverage](https://codeclimate.com/github/NossaVila/nossavila/badges/coverage.svg)](https://codeclimate.com/github/NossaVila/nossavila/coverage)
...
- avaliação/opinião acerca dos serviços
- Painel
- Melhoria do layout da home page
- Seleção de categorias em camadas
- Testes do Cucumber
- Filtragem de busca
- Estabelecimentos (iniciado / implementação parcial)
...
== Considerações finais
 ...
 O projeto está na fase 2 de 3.
 Previsão de conclusão: Dez/2015
