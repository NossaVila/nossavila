...
3. abra o diretório ~NossaVila/nossavila

4.1. Para iniciar a aplicação rode 'rails server'
4.2. Para rodar os testes Rspec, rode 'rspec'


== Applicação na web

 Acesso à aplicação em [link para cloud ainda não disponivel]


== Considerações finais

 O projeto está na fase 1 de 3.
