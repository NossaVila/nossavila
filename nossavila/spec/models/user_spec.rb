...
describe User do
    ...
    #     FactoryGirl.build(:user).email.should be_truthy
    # end
    # it 'is invalid with a duplicate email address' do 
    #     FactoryGirl.build(:user, first_name: "John", email: "tester@example.com")
    ...
    #     expect(FactoryGirl.build(:user, password: "Ab5ertdf").password).to eq("Ab5ertdf")
    # end
    ...
    #     expect(FactoryGirl.build(:user, email: "mario@gmail.com").email).to eq("mario@gmail.com")
    # end
